...
async def compliance_agent(
    ...
    try:
        ...
        if issue_type == "staff":
            safe_reply = (
                f"Hi {reviewer or 'Customer'}, we're sorry for your experience at {store}. "
                "We take all feedback seriously and will look into this matter. "
                "Please share more details through the link provided."
            )
            return {
                "status": "modified",
        ...
        return {
            "status": "approved",
            "final_reply": draft_reply,
            "reason": "Compliance check failed — using original draft",
        }
